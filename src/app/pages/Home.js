...
class Home extends Component<Props> {
  ...
  render() {
    ...
    return (
      <div style={{ 
        backgroundImage: `url("https://media1.thehungryjpeg.com/thumbs2/ori_62315_6a58e3f25625af37dca82a1a90e14652bbcecff2_elegant-cv-and-cover-letter-template.png")` 
      }}>
      <Wrapper>
        <ToastContainer />
        <Main>
